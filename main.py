...
from AIAlgorithms.treesearch import simple_treesearch, simple_graphsearch, breadth_first_search
...
print(f"Problem: {problem}")
solution = breadth_first_search(problem=problem, space=problem_space)
print(f"Solution {solution}")